...
export default defineConfig({
  ...
  use: {
    ...
    //baseURL: 'http://xxx-dadabase-web-demo.azurewebsites.net/',

    // baseURL: process.env.CI ? 
    //   process.env.TEST_ENVIRONMENT == 'PROD' ? 'http://xxx-dadabase.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'DEMO' ? 'http://xxx-dadabase-web-demo.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'DEV' ? 'http://xxx-dadabase-web-dev.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'QA' ? 'http://xxx-dadabase-web-qa.azurewebsites.net' :
    //   'http://xxx-dadabase-web-demo.azurewebsites.net' : 'https://localhost:44349/',
