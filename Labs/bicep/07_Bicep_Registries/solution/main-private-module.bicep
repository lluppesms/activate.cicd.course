...
// ----------------------------------------------------------------------------------------------------
  ...
  module logAnalyticsModule 'br/mybicepregistry:operational-insights/workspace:v9.11.0' = {
...
module appInsitesModule 'br/mybicepregistry:insights/component:v9.11.0' = {
